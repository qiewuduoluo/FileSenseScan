...
echo %color_info%╚══════════════════════════════════════════════════════════════╝%color_reset%
echo.
echo from app.version_manager import get_version_manager > temp_status_script.py
...
REM 创建临时Python脚本文件
echo from app.version_manager import get_version_manager > temp_version_script.py
...
echo %color_info%╚══════════════════════════════════════════════════════════════╝%color_reset%
echo.
echo from app.version_manager import get_version_manager > temp_history_script.py
...
echo %color_warning%╚══════════════════════════════════════════════════════════════╝%color_reset%
echo.
echo from app.version_manager import get_version_manager > temp_rollback_script.py
...
echo %color_error%╚══════════════════════════════════════════════════════════════╝%color_reset%
echo.
echo from app.version_manager import get_version_manager > temp_emergency_script.py
...
echo %color_info%╚══════════════════════════════════════════════════════════════╝%color_reset%
echo.
echo from app.error_monitor import get_error_monitor > temp_error_script.py
